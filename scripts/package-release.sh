...
PACKAGE_ROOT="kitsune-compositor-$VERSION"
...
install -d "$STAGING/$PACKAGE_ROOT/share/licenses/kitsune-compositor"
install -m 0755 "$BINARY_PATH" "$STAGING/$PACKAGE_ROOT/bin/kitsune-compositor"
install -m 0644 "$ROOT/LICENSE" \
  "$STAGING/$PACKAGE_ROOT/share/licenses/kitsune-compositor/LICENSE"
install -d "$DIST_DIR"
